...
- `.claude/references/call-script.md` — the 5-phase call structure and scoring rubric
- `.claude/references/kpi-rubric.md` — detailed scoring criteria per KPI
- `.claude/references/coaching-frameworks.md` — feedback templates and coaching scenarios
